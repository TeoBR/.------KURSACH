...
begin
Select_coffee.Picture.LoadFromFile('D:\\ќјиѕ\\ урсова€\\выбор\\кофе выбор\\FourHealth.png')
end;

procedure TCOFFEE_select.HealthMouseLeave(Sender: TObject);
begin
Select_coffee.Picture.LoadFromFile('D:\\ќјиѕ\\ урсова€\\выбор\\кофе выбор\\ZeroDefoult.png')
end;
...
begin
Select_coffee.Picture.LoadFromFile('D:\\ќјиѕ\\ урсова€\\выбор\\кофе выбор\\ThreeMake2.png')
end;
...
begin
Select_coffee.Picture.LoadFromFile('D:\\ќјиѕ\\ урсова€\\выбор\\кофе выбор\\TwoMake.png')
end;
...
begin
Select_coffee.Picture.LoadFromFile('D:\\ќјиѕ\\ урсова€\\выбор\\кофе выбор\\OneCoffeeTree.png')
end;
