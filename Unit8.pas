...
begin
 Select.Picture.LoadFromFile('D:\ќјиѕ\ урсова€\выбор\кафе выбор\\TwoAmericano.png')
end;

procedure TCAFE_Select.AmericanoMouseLeave(Sender: TObject);
begin
Select.Picture.LoadFromFile('D:\ќјиѕ\ урсова€\выбор\кафе выбор\\ZeroDefoult.png')
end;
...
begin
Select.Picture.LoadFromFile('D:\ќјиѕ\ урсова€\выбор\кафе выбор\\OneJezva.png')
end;
...
begin
Select.Picture.LoadFromFile('D:\ќјиѕ\ урсова€\выбор\кафе выбор\\ThreeProsto.png')
end;
...
begin
Select.Picture.LoadFromFile('D:\ќјиѕ\ урсова€\выбор\кафе выбор\\FourCup.png')
end;
