...
uses Unit9, Unit10, Unit11, Unit12;


procedure TTEA_select.HealthClick(Sender: TObject);
begin
TEA_select.Close;
TEA_Health.Show;
end;
...
begin
Select.Picture.LoadFromFile('D:\ќјиѕ\ урсова€\выбор\чай выбор\FourHealth.png')
end;

procedure TTEA_select.HealthMouseLeave(Sender: TObject);
begin
 Select.Picture.LoadFromFile('D:\ќјиѕ\ урсова€\выбор\чай выбор\ZeroDefolt.png')
end;
...
begin
Select.Picture.LoadFromFile('D:\ќјиѕ\ урсова€\выбор\чай выбор\TwoHistory.png')
end;
...
procedure TTEA_select.Image2Click(Sender: TObject);
begin
TEA_select.Close;
Select.Show;
end;
...
begin
Select.Picture.LoadFromFile('D:\ќјиѕ\ урсова€\выбор\чай выбор\OneSort.png')
end;
...
begin
Select.Picture.LoadFromFile('D:\ќјиѕ\ урсова€\выбор\чай выбор\ThreeTraditional.png')
end;
